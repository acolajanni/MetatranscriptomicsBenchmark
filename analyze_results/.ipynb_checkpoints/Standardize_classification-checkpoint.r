...
classif_sa=read.delim(paste0(result_dir_salmon,"ContigsToReads/ReadsClassif.txt"),fill=TRUE, sep=',', skip = 1, header=FALSE)
classif_sa[,c("read","superkingdom","phylum", "class", "order", "family", "genus", "species","strain")]=
  str_split_fixed(classif_sa$V1, fixed(' '), n=9)
...
dir.create(paste0(path,"results/",dataset,"/rdata/"))
