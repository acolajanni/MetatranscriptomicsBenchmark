...
# transcript_dir=paste0(path, "/data/Simulation/with_replacement/transcripts/2/")
# data_dir=paste0(path, "data/Simulation/with_replacement/")
# n_transcript="all"
...
# 
# n_transcript_label=as.character(n_transcript)
# 
# for (tr in transcripts) {
#   phylum <- str_remove(tr, paste0("_", n_transcript_label, ".fasta"))
#   print(phylum)
#   
#   # Create directories
...
#   if(n_transcript == "all"){n_transcript = true_n_transcript}
...
for (tr in transcripts) {
  # Set transcript count based on input label
  fasta_path <- paste0(transcript_dir, tr)
  true_n_transcript <- nrow(scanFasta(fasta_path))
  ...
  # Set phylum after knowing the label
  phylum <- str_remove(tr, paste0("_", n_transcript_label, ".fasta"))
  print(phylum)
