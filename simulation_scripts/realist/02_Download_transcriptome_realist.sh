...
for ftp_path in $(awk -v FS='\t' '{print $9}' ${DATABASE_PATH}/selected_genomes/realist/selected_genomes_realist.tsv) ; do
...
echo "done" > ${DATABASE_PATH}/selected_genomes/realist/is_it_done.txt