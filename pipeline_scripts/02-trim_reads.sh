...
#############################
#SBATCH -J SimuTRI
#SBATCH --array=0-471%20
#############################
## array=0-10%5 ==> 11 job, 5 à la fois
...
# for SRA_ID in $ID_list ; do
    ...
    if [ ${SEQ_TYPE} = "PE" ] ; then 
        ...
        # trimmomatic PE -threads 20 -phred33  $READ1_path $READ2_path \
        #         ${output_path_R1}.trimmed.fastq${RAW_extension} ${OUTPUT_PATH}Orphaned_reads/${SRA_ID}_1_orphanedReads.fastq${RAW_extension} \
        #         ${output_path_R2}.trimmed.fastq${RAW_extension} ${OUTPUT_PATH}Orphaned_reads/${SRA_ID}_2_orphanedReads.fastq${RAW_extension} \
        #         ILLUMINACLIP:$adapter_path:4:40:15 \
        #         LEADING:2 TRAILING:2 \
        #         SLIDINGWINDOW:4:15 \
        #         MINLEN:36
        ...
        trimmomatic SE -threads 8 -phred33 \
                ...
                ILLUMINACLIP:$adapter_path:3:40:15 \
                LEADING:2 TRAILING:2 \
                SLIDINGWINDOW:4:15 \
                MINLEN:36
